    ...
    <!--<main class="mt-5 pt-3">-->
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-warning text-dark h-100">
              <!--<div class="card-body py-5">Warning Card</div>-->
			        <div class="card-body py-5"><h3 class="card-title">Assigned</h3></div>
              ...
              <a href ='D1_ASSIGNED_ITM.php' style="color: black">View Details</a>
                <span class="ms-auto">
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-success text-white h-100">
			  ...
			  <div class="card-body py-5"><h3 class="card-title">Done!!!</h3></div>
          <?php
          ...
          ?>
              ...
              <div class="card-footer d-flex">
              <a href ='D2_DONE_ITM.php' style="color: white">View Details</a>
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
                </span>
              </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-primary text-white h-100">
			  ...
			  <div class="card-body py-5"><h3 class="card-title">Assign to Service Company</h3></div>
        <?php
        ...
        ?>
              ...
              <div class="card-footer d-flex">
                <a href ='D3_ASC_ITM.php' style="color: white">View Details</a>
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
                </span>
              </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-danger text-white h-100">
			  ...
			  <div class="card-body py-5"><h3 class="card-title">Cannot Repair</h3></div>
              <?php
              ...
              <div class="card-footer d-flex">
              <a href ='D4_CR_ITM.php' style="color: white">View Details</a>
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
                </span>
              </div>

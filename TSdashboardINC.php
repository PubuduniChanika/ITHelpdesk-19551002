    ...
    <!--<main class="mt-5 pt-3">-->
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-warning text-dark h-100">
              ...
              <a href ='D1_ASSIGNED.php' style="color: black">View Details</a>
                <span class="ms-auto">
          ...
          ?>
              ...
              <div class="card-footer d-flex">
              <a href ='D2_DONE.php' style="color: white">View Details</a>
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
                </span>
              </div>
        ...
        ?>
              ...
              <div class="card-footer d-flex">
                <a href ='D3_ASC.php' style="color: white">View Details</a>
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
                </span>
              </div>
          ...
          <div class="col-md-3 mb-3">
            <div class="card bg-danger text-white h-100">
              ...
              <div class="card-footer d-flex">
              <a href ='D4_CR.php' style="color: white">View Details</a>
                <span class="ms-auto">
                  <i class="bi bi-chevron-right"></i>
                </span>
              </div>

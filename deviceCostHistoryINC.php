				...
				<div class="card-body">
					<div class="table-responsive">
						<table class="table table-striped" style="width: 100%">
							...
							<tbody>
								<?php
								$sel_query2 = "SELECT trouble.rno,`name`,`branch`,`designation`,`sn`,`dcat`,`trouble`,`pn`,`date`,`assignee`,`status`,`service_company`,`acc_no`,`amount`,assignedsc.review FROM `trouble` LEFT JOIN`assignedsc` ON trouble.rno=assignedsc.rno where `status`='Assign to Service Company' and `sn`='$sn' ";

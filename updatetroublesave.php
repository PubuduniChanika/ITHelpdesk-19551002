...
$query="update trouble set `name`='$name',`designation`='$designation',`branch`='$branch',`sn`='$sn',`dcat`='$dcat',`trouble`='$trouble',`pn`='$pn',`date`='$date',`assignee`='$assignee',`status`='$status' where `rno`='$rno'";
}

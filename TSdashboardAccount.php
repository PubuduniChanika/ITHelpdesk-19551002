    ...
    <div class="row">
      ...
      <div class="col-md-3 mb-3">
        <div class="card bg-warning text-dark h-100">
          ...
          <div class="card-footer d-flex">
            <a href='D1_ASSIGNED_ACC.php' style="color: black">View Details</a>
            <span class="ms-auto">
      ...
      <div class="col-md-3 mb-3">
        <div class="card bg-success text-white h-100">
          ...
          <div class="card-footer d-flex">
            <a href='D2_DONE_ACC.php' style="color: white">View Details</a>
            <span class="ms-auto">
              <i class="bi bi-chevron-right"></i>
            </span>
          </div>
      ...
      <div class="col-md-3 mb-3">
        <div class="card bg-primary text-white h-100">
          ...
          <div class="card-footer d-flex">
            <a href='D3_ASC_ACC.php' style="color: white">View Details</a>
            <span class="ms-auto">
              <i class="bi bi-chevron-right"></i>
            </span>
          </div>
      ...
      <div class="col-md-3 mb-3">
        <div class="card bg-danger text-white h-100">
          ...
          <div class="card-footer d-flex">
            <a href='D4_CR_ACC.php' style="color: white">View Details</a>
            <span class="ms-auto">
              <i class="bi bi-chevron-right"></i>
            </span>
          </div>

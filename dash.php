...
<html lang="en">
  ...
  $queryDesktop = "
    SELECT 
      branch as branch,
        COUNT(sn) as amount
    FROM device WHERE type='Desktop'
    GROUP BY branch
  ";
  $resultLaptop=mysqli_query($linkID,$queryLaptop);
  $resultDesktop=mysqli_query($linkID,$queryDesktop);
  ...
  foreach($resultDesktop as $data)
  {
    $branchDesktop[] = $data['branch'];
    $amountDesktop[] = $data['amount']; 
  }
